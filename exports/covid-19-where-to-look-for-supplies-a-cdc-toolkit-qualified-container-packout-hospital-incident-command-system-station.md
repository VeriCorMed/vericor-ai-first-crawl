Call 608-526-6901 to check the lead time for ANY time-sensitive need! [Dismiss](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/)
[Skip to navigation](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#site-navigation) [Skip to content](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#content)
...
Search for: Search
Search for: Search
Menu [Skip Navigation](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-main-1078-primary-2-skipnav)
...
Fri 8am-12pm (CST) ](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/)
  ...
  * [Shop](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/)
  ...
  * [Cold Chain Management](https://www.vericormed.com/cold-chain-management/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE (Payload)](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
  ...
  * [Emergency Preparedness](https://www.vericormed.com/emergency-preparedness/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
    * [… or SELECT AN INDUSTRY](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
  ...
  * [Storage/Organization](https://www.vericormed.com/medical-cases/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
  ...
  * [Resources](https://www.vericormed.com/resources/)Expand child menu
    ...
    * [VeriCor](https://www.vericormed.com/about-vericor-medical-systems/)Expand child menu
      ...
      * [Our W-9](https://www.vericormed.com/download-pdf/vericor-w-9-signed-pdf/)
    * [Employment Opportunities](https://www.vericormed.com/employment/)
    * [Phone](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
    * [Hours](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
    ...
    * [Trademarks](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)Expand child menu
      ...
      * [SmartBook™](https://www.vericormed.com/smartbook-system-operations-manual/)
      * [More…](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)
    * [Email](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
    * [Fax](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/#ubermenu-custom_content)
  * [Shop](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/)Expand child menu
    * [2-8°C Coolers (Vaccine/Medication)](https://www.vericormed.com/refrigerated-2-to-8c/)
    * [1-10°C Coolers (Blood Products)](https://www.vericormed.com/fridge-1-to-10c-1-to-6c/)
    * [-50 to -15°C Coolers (Varicella, etc.)](https://www.vericormed.com/frozen-50-to-15c/)
    * [15-25°C Coolers (FFPE, meds, etc.)](https://www.vericormed.com/room-15-to-25c-20-to-24c-2/)
...
[Home](https://www.vericormed.com) / [Emergency Management](https://www.vericormed.com/category/emergency-management/) / COVID-19: Where to Look for Supplies | A CDC Toolkit “Qualified Container & Packout” | Hospital Incident Command System Station
...
# COVID-19: Where to Look for Supplies | A CDC Toolkit “Qualified Container & Packout” | Hospital Incident Command System Station
...
### A) COVID-19: Where to Look for Supplies
#### PPE products in hot demand.
As the coronavirus (COVID-19) continues to advance, the request for personal protective equipment (PPE) is increasing. A decrease in available supply and an increase in demand have suppliers utilizing allocation methods. Unfortunately, as a assembler/manufacturer we are not on the top of the list to get supplies. So due to current demand and limited procurement, VeriCor is not taking orders for [Infection Control and Prevention PPE](https://www.vericormed.com/specialized-response/) at this time. If interested in ordering in the future or to be put on the wait list, email a request to info@vericormed.com.
Currently, your best source to get PPE is through your normal purchasing channels such as a GPO (group purchasing organization). Rationed supplies for businesses like ours come after the front lines (public health, hospitals, etc.) are taken care of. So while we would love to organize the PPE into nice, [Response-Friendly® kits](https://www.vericormed.com/specialized-response/), we will need to wait until this storm passes in order to get you ready for the next—what preparedness is all about.
...
#### For 2-8, 1-10, 20-24, & -50 to -15C backup/transport.
Easy to use phase change material (PCM) panels hold contents at the desired temperature for an extended period of time. Smaller qualified coolers last 3+ days. Larger qualified coolers last 5+ days. This peace-of-mind is valuable for transport, backup and off-site use. Each of the four sizes of coolers can maintain a refrigerated, frozen, or controlled room temperature dependent upon the PCM panel system you use. If you haven’t already, watch this [113-second explainer video](https://youtu.be/N9G9pjNjopU) to see the simplicity and effectiveness of Cool Cube™ PCM Coolers.
...
Establish command and control with a mobile HICS (Hospital Incident Command System) case. During storage it is out of the way and takes up the space of a desk. But during deployment it transforms into a serious multi-tool with a power management system, table, organizational chart, overhead light, laptop stand, inlay map/document grease board, and numerous drawers and shelves that enable supply organization. Pair it with the [HICS Support Module](https://www.vericormed.com/product/hospital-incident-command-support-module-sm-hics/) (or your own kit) and be ready to respond anytime, anywhere.
...
### Share this:
  * [ Click to share on X (Opens in new window) X ](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/?share=twitter&nb=1)
  * [ Click to share on Facebook (Opens in new window) Facebook ](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/?share=facebook&nb=1)
...
## Post navigation
[Previous post: Response-Friendly® Medical Kits | Alternate Care Site (ACS) System | An emergency room in a tent](https://www.vericormed.com/response-friendly-medical-kits-alternate-care-site-acs-system-an-emergency-room-in-a-tent/)
[Next post: Leadership During Crisis | Simplify Packout for the Next Time | Kits for Protecting Staff & Patients](https://www.vericormed.com/leadership-during-crisis-simplify-packout-kits-for-protecting-staff-and-patients/)
...
[Built with WooCommerce](https://woocommerce.com "WooCommerce - The Best eCommerce Platform for WordPress"). 
  ...
  * [Search](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/)
Search for: Search
...
[![StatCounter - Free Web Tracker and Counter](https://www.vericormed.com/covid-19-where-to-look-for-supplies-a-cdc-toolkit-qualified-container-packout-hospital-incident-command-system-station/)](https://www.statcounter.com/) ![](https://pixel.wp.com/g.gif?v=ext&blog=225313269&post=16546&tz=-5&srv=www.vericormed.com&j=1%3A15.0&host=www.vericormed.com&ref=&fcp=0&rand=0.04673113745332058)
  *[*]: required
