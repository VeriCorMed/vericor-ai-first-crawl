Call 608-526-6901 to check the lead time for ANY time-sensitive need! [Dismiss](https://www.vericormed.com/smartbook-system-operations-manual/)
[Skip to navigation](https://www.vericormed.com/smartbook-system-operations-manual/#site-navigation) [Skip to content](https://www.vericormed.com/smartbook-system-operations-manual/#content)
...
Search for: Search
Search for: Search
Menu [Skip Navigation](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-main-1078-primary-2-skipnav)
...
Fri 8am-12pm (CST) ](https://www.vericormed.com/smartbook-system-operations-manual/)
  ...
  * [Shop](https://www.vericormed.com/smartbook-system-operations-manual/)
  ...
  * [Cold Chain Management](https://www.vericormed.com/cold-chain-management/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE (Payload)](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
  ...
  * [Emergency Preparedness](https://www.vericormed.com/emergency-preparedness/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
    * [… or SELECT AN INDUSTRY](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
  ...
  * [Storage/Organization](https://www.vericormed.com/medical-cases/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
  ...
  * [Resources](https://www.vericormed.com/resources/)Expand child menu
    ...
    * [VeriCor](https://www.vericormed.com/about-vericor-medical-systems/)Expand child menu
      ...
      * [Our W-9](https://www.vericormed.com/download-pdf/vericor-w-9-signed-pdf/)
    * [Employment Opportunities](https://www.vericormed.com/employment/)
    * [Phone](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
    * [Hours](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
    ...
    * [Trademarks](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)Expand child menu
      ...
      * [SmartBook™](https://www.vericormed.com/smartbook-system-operations-manual/)
      * [More…](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)
    * [Email](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
    * [Fax](https://www.vericormed.com/smartbook-system-operations-manual/#ubermenu-custom_content)
  * [Shop](https://www.vericormed.com/smartbook-system-operations-manual/)Expand child menu
    * [2-8°C Coolers (Vaccine/Medication)](https://www.vericormed.com/refrigerated-2-to-8c/)
    * [1-10°C Coolers (Blood Products)](https://www.vericormed.com/fridge-1-to-10c-1-to-6c/)
    * [-50 to -15°C Coolers (Varicella, etc.)](https://www.vericormed.com/frozen-50-to-15c/)
    * [15-25°C Coolers (FFPE, meds, etc.)](https://www.vericormed.com/room-15-to-25c-20-to-24c-2/)
...
[Home](https://www.vericormed.com) / SmartBook™
# SmartBook™
![SmartBook™ header](https://www.vericormed.com/wp-content/uploads/2022/08/smartbook-header.png)
### **Empowering Emergency Response: The VeriCor SmartBook™**
The VeriCor SmartBook™ is the cornerstone of every Response-Friendly™ System. This exclusive management tool provides a comprehensive, intuitive guide to your system’s supplies and equipment. The SmartBook™ optimizes emergency response by
  * **Accelerating Deployment:** Quickly locate and deploy essential supplies during emergencies.
  * **Streamlining Maintenance:** Simplify inventory management and supply rotation for all system components.
  * **Enhancing Training and Drills:** Essential data and item locations improve team readiness during exercises.
  * **Supporting Audit Preparedness:** Detailed data organized to ensure readiness for inspections and reviews.
  * **Facilitating Post-Deployment Recovery:** Accurate and efficient system reorganization after use.
...
`  
 ...
 ``  
 `
![sb - key features](https://www.vericormed.com/wp-content/uploads/2024/12/sb-key-features-300x255.png)
### Key Features of the SmartBook™
Every SmartBook™ is designed to be your go-to resource for managing your system. It includes:
![sb - visual](https://www.vericormed.com/wp-content/uploads/2024/12/visual-300x218.png)
### Visual System Layout
`  
 ``  
 `  
Provides comprehensive visual guidance for system organization (even within a trailer when applicable), including layer-by-layer breakdowns for efficient deployment and repacking.  
`  
 `
![sb - module](https://www.vericormed.com/wp-content/uploads/2024/12/sb-module-300x137.png)
### Module and Case Details
`  
 ``  
 `  
Connects care functions to alphanumeric cases, providing images and detailed inventory lists for each module and case.  
`  
 `
![sb - inventories](https://www.vericormed.com/wp-content/uploads/2024/12/sb-inventories-300x241.png)
### Comprehensive Inventories
`  
 ``  
 `  
Offers complete system inventories sorted by both description and location for rapid item retrieval.  
`  
 `
![sb - digital](https://www.vericormed.com/wp-content/uploads/2024/12/sb-digital.png)
### Digital Resources
`  
 ``  
 ``  
 `  
A USB includes a digital copy of the SmartBook™, a comprehensive inventory spreadsheet (with detailed data such as descriptions, quantities, locations, lot numbers, serial numbers, expiration dates, part numbers, and purchase dates), and Safety Data Sheets (SDS).  
`  
 `
`  
 `  
The VeriCor SmartBook™ is more than an operations manual; it’s an indispensable tool for emergency preparedness managers. With its detailed visuals, comprehensive inventory lists, and accessible digital resources, the SmartBook™ ensures your system is always ready for action.
For more information on this exclusive management tool, or to request a demo, contact a VeriCor representative today at (608) 526-6901.
...
[Built with WooCommerce](https://woocommerce.com "WooCommerce - The Best eCommerce Platform for WordPress"). 
  ...
  * [Search](https://www.vericormed.com/smartbook-system-operations-manual/)
Search for: Search
...
[![StatCounter - Free Web Tracker and Counter](https://www.vericormed.com/smartbook-system-operations-manual/)](https://www.statcounter.com/) ![](https://pixel.wp.com/g.gif?v=ext&blog=225313269&post=94&tz=-5&srv=www.vericormed.com&j=1%3A15.0&host=www.vericormed.com&ref=&fcp=4388&rand=0.7092210182023598)
  *[*]: required
