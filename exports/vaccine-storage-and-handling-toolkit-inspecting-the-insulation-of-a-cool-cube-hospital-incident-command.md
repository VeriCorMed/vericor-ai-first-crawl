Call 608-526-6901 to check the lead time for ANY time-sensitive need! [Dismiss](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/)
[Skip to navigation](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#site-navigation) [Skip to content](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#content)
...
Search for: Search
Search for: Search
Menu [Skip Navigation](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-main-1078-primary-2-skipnav)
...
Fri 8am-12pm (CST) ](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/)
  ...
  * [Shop](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/)
  ...
  * [Cold Chain Management](https://www.vericormed.com/cold-chain-management/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE (Payload)](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
  ...
  * [Emergency Preparedness](https://www.vericormed.com/emergency-preparedness/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
    * [… or SELECT AN INDUSTRY](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
  ...
  * [Storage/Organization](https://www.vericormed.com/medical-cases/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
  ...
  * [Resources](https://www.vericormed.com/resources/)Expand child menu
    ...
    * [VeriCor](https://www.vericormed.com/about-vericor-medical-systems/)Expand child menu
      ...
      * [Our W-9](https://www.vericormed.com/download-pdf/vericor-w-9-signed-pdf/)
    * [Employment Opportunities](https://www.vericormed.com/employment/)
    * [Phone](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
    * [Hours](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
    ...
    * [Trademarks](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)Expand child menu
      ...
      * [SmartBook™](https://www.vericormed.com/smartbook-system-operations-manual/)
      * [More…](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)
    * [Email](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
    * [Fax](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/#ubermenu-custom_content)
  * [Shop](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/)Expand child menu
    * [2-8°C Coolers (Vaccine/Medication)](https://www.vericormed.com/refrigerated-2-to-8c/)
    * [1-10°C Coolers (Blood Products)](https://www.vericormed.com/fridge-1-to-10c-1-to-6c/)
    * [-50 to -15°C Coolers (Varicella, etc.)](https://www.vericormed.com/frozen-50-to-15c/)
    * [15-25°C Coolers (FFPE, meds, etc.)](https://www.vericormed.com/room-15-to-25c-20-to-24c-2/)
...
[Home](https://www.vericormed.com) / [Emergency Management](https://www.vericormed.com/category/emergency-management/) / Vaccine Storage and Handling Toolkit | Inspecting the Insulation of a Cool Cube™ | Hospital Incident Command
...
# Vaccine Storage and Handling Toolkit | Inspecting the Insulation of a Cool Cube™ | Hospital Incident Command
![Vaccine Storage and Handling Toolkit 2023](https://www.vericormed.com/wp-content/uploads/2023/01/Vaccine-Storage-and-Handling-Toolkit-2023.jpg)
...
🦺 A Mobile Case for HICS  
🔥 Burn Care Treatment (Surge)
...
![Vaccine Storage and Handling Toolkit 2023](https://www.vericormed.com/wp-content/uploads/2023/01/Vaccine-Storage-and-Handling-Toolkit-2023.jpg)
### A) Vaccine Storage and Handling Toolkit (1/11/23)
#### the latest from the CDC
A couple of weeks ago (January 11, 2023), the CDC published the new “Vaccine Storage and Handling Toolkit.” Find it [here](https://www.vericormed.com/toolkit-history/), along with all the other versions dating back to 2012.
Before meticulously studying the 70-page document, know that we will publish our always-popular “What’s Changed?” next time. It will give insight into the important (and not so necessary) changes since the last edition, so stay tuned…
News & Promotions
![VIP inspection](https://www.vericormed.com/wp-content/uploads/2020/01/VIP-inspection.png)
### A) Inspecting the Insulation of a Cool Cube™
#### How can you tell?
The insulation of a Cool Cube™ is a critical component of its 4+ day temperature hold time. So if a decline in the performance is sensed, inspect the Temp-Shield™ Insulation System. A loose skin indicates vacuum loss (damage, puncture, leak, etc.). Without a vacuum seal, the panel(s) becomes like any other insulator and don’t hold the internal temperature as long. [Click here to learn more about Cool Cube™ life expectancy and how to inspect and validate the cooler for years of use.](https://www.vericormed.com/inspecting-and-validating-a-cooler/)
...
### B) A Mobile Case for Hospital Incident Command
#### Compact Incident Command Station
Establish command and control with a mobile HICS (Hospital Incident Command System) station. During storage, it will be out of the way and take up the footprint of a desk. During deployment, it transforms into a great multi-tool with a power management system, table, organizational chart, overhead light, laptop stand, inlay map/document grease board, and numerous drawers and shelves to enable supply organization. Pair it with the [HICS Support Module](https://www.vericormed.com/product/hospital-incident-command-support-module-sm-hics/) (or your kit), and be ready to respond anytime and anywhere! Click the picture/button to learn more, or call 608-526-6901 to speak with an experienced VeriCor staff member today.
...
### C) Treat a Surge of Burn Care Patients
#### In our exclusive & portable Upright Medical Organizer.
Get the essential supplies needed for the debridement and dressing of burn patients. Be ready for multiple burn patients with the field-ready [Burn Care MedKit](https://www.vericormed.com/product/burn-care-medical-kit-module-mk-bc/). Intuitively organized into a unique [Upright Medical Organizer](https://www.vericormed.com/product/upright-medical-organizer-mc-umo-medical-roll-pack/) (MC-UMO), this kit has many features EP organizers and responders appreciate, like clear pockets, an easy-to-assemble stand, a product management SmartBook™, etc. Learn more by clicking the picture (or button) or calling 608-526-6901 to talk to an experienced VeriCor staff member today.
[Learn More](https://www.vericormed.com/product/upright-medical-organizer-mc-umo-medical-roll-pack/ "Learn More")
...
### Share this:
  * [ Click to share on X (Opens in new window) X ](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/?share=twitter&nb=1)
  * [ Click to share on Facebook (Opens in new window) Facebook ](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/?share=facebook&nb=1)
...
## Post navigation
[Previous post: Specialized Phase Change Material | A cooler you can count on in 2023 | Medical Kits](https://www.vericormed.com/specialized-phase-change-material-a-cooler-you-can-count-on-in-2023-medical-kits/)
[Next post: CDC Vaccine Storage and Handling Toolkit Review | Cool Cube™ Shipping Fast](https://www.vericormed.com/cdc-vaccine-storage-and-handling-toolkit-review-cool-cube-shipping-fast/)
...
[Built with WooCommerce](https://woocommerce.com "WooCommerce - The Best eCommerce Platform for WordPress"). 
  ...
  * [Search](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/)
Search for: Search
...
[![StatCounter - Free Web Tracker and Counter](https://www.vericormed.com/vaccine-storage-and-handling-toolkit-inspecting-the-insulation-of-a-cool-cube-hospital-incident-command/)](https://www.statcounter.com/) ![](https://pixel.wp.com/g.gif?v=ext&blog=225313269&post=122306&tz=-5&srv=www.vericormed.com&j=1%3A15.0&host=www.vericormed.com&ref=&fcp=3580&rand=0.6822469281774894)
  *[*]: required
