Call 608-526-6901 to check the lead time for ANY time-sensitive need! [Dismiss](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
[Skip to navigation](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#site-navigation) [Skip to content](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#content)
...
Search for: Search
Search for: Search
Menu [Skip Navigation](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-main-1078-primary-2-skipnav)
...
Fri 8am-12pm (CST) ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
  ...
  * [Shop](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
  ...
  * [Cold Chain Management](https://www.vericormed.com/cold-chain-management/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE (Payload)](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
  ...
  * [Emergency Preparedness](https://www.vericormed.com/emergency-preparedness/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
    * [… or SELECT AN INDUSTRY](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
  ...
  * [Storage/Organization](https://www.vericormed.com/medical-cases/)Expand child menu
    * [SELECT A CATEGORY](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
    * [… or SELECT A PURPOSE](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
  ...
  * [Resources](https://www.vericormed.com/resources/)Expand child menu
    ...
    * [VeriCor](https://www.vericormed.com/about-vericor-medical-systems/)Expand child menu
      ...
      * [Our W-9](https://www.vericormed.com/download-pdf/vericor-w-9-signed-pdf/)
    * [Employment Opportunities](https://www.vericormed.com/employment/)
    * [Phone](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
    * [Hours](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
    ...
    * [Trademarks](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)Expand child menu
      ...
      * [SmartBook™](https://www.vericormed.com/smartbook-system-operations-manual/)
      * [More…](https://www.vericormed.com/trademarks-of-vericor-medical-systems/)
    * [Email](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
    * [Fax](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#ubermenu-custom_content)
  * [Shop](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)Expand child menu
    * [2-8°C Coolers (Vaccine/Medication)](https://www.vericormed.com/refrigerated-2-to-8c/)
    * [1-10°C Coolers (Blood Products)](https://www.vericormed.com/fridge-1-to-10c-1-to-6c/)
    * [-50 to -15°C Coolers (Varicella, etc.)](https://www.vericormed.com/frozen-50-to-15c/)
    * [15-25°C Coolers (FFPE, meds, etc.)](https://www.vericormed.com/room-15-to-25c-20-to-24c-2/)
...
[Home](https://www.vericormed.com) / [Medical Cases](https://www.vericormed.com/product-category/medical-organizers-spec-sheets/) / Mobile Incident Command Center
[](javascript:%20void\(0\);)
![Mobile Incident Command Center \(Red\) -- MC-MICC-RD](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Hospital Incident Command Station color square](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center -- Loaded](https://www.vericormed.com/wp-content/uploads/2014/01/Mobile-Incident-Command-Center-Loaded-600x600.png)
![Mobile Incident Command Center -- on-w-compluter](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center -- w-light-on](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center -- Input Jacks](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center -- Table](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center \(Red\) -- MC-MICC-RD](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Hospital Incident Command Station color square](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center -- Loaded](https://www.vericormed.com/wp-content/uploads/2014/01/Mobile-Incident-Command-Center-Loaded-600x600.png)
![Mobile Incident Command Center -- on-w-compluter](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
...
[](javascript:%20void\(0\);)
[ ](javascript:%20void\(0\);)
![Mobile Incident Command Center -- Loaded](https://www.vericormed.com/wp-content/uploads/2014/01/Mobile-Incident-Command-Center-Loaded-100x100.png)
![Mobile Incident Command Center -- on-w-compluter](https://www.vericormed.com/wp-content/uploads/2014/01/Mobile-Incident-Command-Center-on-w-compluter-100x100.png)
![Mobile Incident Command Center -- w-light-on](https://www.vericormed.com/wp-content/uploads/2014/01/Mobile-Incident-Command-Center-w-light-on-100x100.png)
![Mobile Incident Command Center -- Input Jacks](https://www.vericormed.com/wp-content/uploads/2014/01/Mobile-Incident-Command-Center-Input-Jacks-100x100.png)
![Mobile Incident Command Center -- Table](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Mobile Incident Command Center \(Red\) -- MC-MICC-RD](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![Hospital Incident Command Station color square](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
[ ](javascript:%20void\(0\);) [ ](javascript:%20void\(0\);)
# Mobile Incident Command Center
For Mobilizing Incident Command
SKU: 
MC-MICC
A self-contained case that establishes command and control quickly and easily. This mobile station comes with features found in typical command centers, with room to organize/ready supplies for the next logistical, operational, or command situation.
$6,999.00
Qty:
This product is made to order. Call 608-526-6901 to talk about pricing and an estimated lead time.
Available Colors |  Choose an option Black Forest Green Green Navy Blue Orange Red Silver Tan Violet Blue Wine Yellow[Clear](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)  
---|---  
Add Accessories
...
Add for $999.00
Mobile Incident Command Center quantity
Add to Order Quote Item
  * [ Overview ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#tab-technology)
  * [ Literature ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#tab-support)
  * [ FAQs ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/#tab-faqs)


The Mobile Incident Command Station (MC-MICC) enables hospitals to quickly and easily establish command and control from one centralized mobile command station. Organize and store all incident supplies within this compact, mobile unit. It features an adjustable laptop stand, overhead light, data jacks, inlay map/doc grease board, two Easyboards®, a wide wheel base, detachable fold-out table, and is fully lockable. Be prepared the next time an incident happens and a mobile solution is needed.
### Technology & Features
![MC-MICC magnifying](https://www.vericormed.com/wp-content/uploads/2014/01/MC-MICC-magnifying.png)
...
[![](https://www.vericormed.com/wp-content/uploads/2017/11/PDF-ICON.jpg)](https://www.vericormed.com/download-pdf/mobile-incident-command-center-mc-micc-spec-sheet-022719/)
#### [MC-MICC Spec Sheet](https://www.vericormed.com/download-pdf/mobile-incident-command-center-mc-micc-spec-sheet-022719/)
## FAQs
### **General FAQ**
[ l Can credit cards be used for purchasing?  ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
Yes, all major credit cards are accepted. 
[ l What is the ordering process?  ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
...
[ l What information is needed to order via credit card?  ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
Name on card, card #, expiration date, security code, billing address.
[ l Where can these be purchased?  ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
Direct from the website, and or on the GSA website. For larger orders or for a formal quote, please call (866) 469-6019.
[ L Made to Order  ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
...
[Built with WooCommerce](https://woocommerce.com "WooCommerce - The Best eCommerce Platform for WordPress"). 
  ...
  * [Search](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
Search for: Search
...
[![StatCounter - Free Web Tracker and Counter](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)](https://www.statcounter.com/)
[ ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/) [ ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
Loading Comments...
You must be [logged in](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/) to post a comment. 
[ ](https://www.vericormed.com/product/mobile-incident-command-center-mc-micc/)
![](https://pixel.wp.com/g.gif?v=ext&blog=225313269&post=588&tz=-5&srv=www.vericormed.com&j=1%3A15.0&host=www.vericormed.com&ref=&fcp=7368&rand=0.9607397613275932)
Notifications
  *[*]: required
